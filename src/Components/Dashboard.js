    ...
    render(){
        return(
            <div>
                ...
                />
                 <FilterButtons
                        buttonInfo={[{ariaLabel:'all types of posts',icon_type:'text-all', display_change:'all', link:'/dashboard',tooltipMessage:'view posts of all types ',tooltipClass:'bottom-right'},
                        ...
                        display_change:'event',tooltipMessage:'view only event posts',tooltipClass:'bottom-left'}]}
                ...
                <footer>
                <FilterButtons
                        buttonInfo={[{ariaLabel:'all users',icon_type:faUsers, link:'/dashboard',display_change:'allUsers',tooltipMessage:'view all posts of all users', tooltipClass:'top-right'},
